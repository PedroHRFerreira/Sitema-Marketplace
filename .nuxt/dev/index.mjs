...
} from "file:///home/braip/%C3%81rea%20de%20Trabalho/braip/Simulate-Marktplace/marketplace/node_modules/h3/dist/index.mjs";
import {
  getRequestDependencies,
  getPreloadLinks,
  getPrefetchLinks,
  createRenderer,
} from "file:///home/braip/%C3%81rea%20de%20Trabalho/braip/Simulate-Marktplace/marketplace/node_modules/vue-bundle-renderer/dist/runtime.mjs";
import {
  stringify,
  uneval,
} from "file:///home/braip/%C3%81rea%20de%20Trabalho/braip/Simulate-Marktplace/marketplace/node_modules/devalue/index.js";
import {
  parseURL,
  withoutBase,
  joinURL,
  getQuery,
  withQuery,
} from "file:///home/braip/%C3%81rea%20de%20Trabalho/braip/Simulate-Marktplace/marketplace/node_modules/ufo/dist/index.mjs";
...
} from "file:///home/braip/%C3%81rea%20de%20Trabalho/braip/Simulate-Marktplace/marketplace/node_modules/ofetch/dist/node.mjs";
...
import {
  createCall,
  createFetch,
} from "file:///home/braip/%C3%81rea%20de%20Trabalho/braip/Simulate-Marktplace/marketplace/node_modules/unenv/runtime/fetch/index.mjs";
...
import defu, {
  defuFn,
} from "file:///home/braip/%C3%81rea%20de%20Trabalho/braip/Simulate-Marktplace/marketplace/node_modules/defu/dist/defu.mjs";
...
import {
  createStorage,
  prefixStorage,
} from "file:///home/braip/%C3%81rea%20de%20Trabalho/braip/Simulate-Marktplace/marketplace/node_modules/unstorage/dist/index.mjs";
...
import {
  toRouteMatcher,
  createRouter,
} from "file:///home/braip/%C3%81rea%20de%20Trabalho/braip/Simulate-Marktplace/marketplace/node_modules/radix3/dist/index.mjs";
...
import {
  ...
  createIPX,
  createIPXH3Handler,
} from "file:///home/braip/%C3%81rea%20de%20Trabalho/braip/Simulate-Marktplace/marketplace/node_modules/ipx/dist/index.mjs";
...
import {
  version,
  unref,
} from "file:///home/braip/%C3%81rea%20de%20Trabalho/braip/Simulate-Marktplace/marketplace/node_modules/vue/index.mjs";
...
const serverAssets = [
  {
    baseName: "server",
    dir: "/home/braip/Área de Trabalho/braip/Simulate-Marktplace/marketplace/server/assets",
  },
];
...
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: true,
    base: "/home/braip/Área de Trabalho/braip/Simulate-Marktplace/marketplace",
...
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: true,
    base: "/home/braip/Área de Trabalho/braip/Simulate-Marktplace/marketplace/server",
    ignore: ["**/node_modules/**", "**/.git/**"],
  })
);
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: false,
    base: "/home/braip/Área de Trabalho/braip/Simulate-Marktplace/marketplace/.nuxt",
    ignore: ["**/node_modules/**", "**/.git/**"],
  })
);
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: false,
    base: "/home/braip/Área de Trabalho/braip/Simulate-Marktplace/marketplace/.nuxt/cache",
    ignore: ["**/node_modules/**", "**/.git/**"],
  })
);
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    base: "/home/braip/Área de Trabalho/braip/Simulate-Marktplace/marketplace/.data/kv",
    ignore: ["**/node_modules/**", "**/.git/**"],
  })
);
...
function defineRenderHandler(handler) {
  return eventHandler(async (event) => {
    if (event.path.endsWith("null")) {
      setResponseHeader(event, "Content-Type", "null");
      return send(
        event,
...
const _UZaFQW = lazyEventHandler(() => {
  ...
  const fsDir = opts?.fs?.dir
    ? (Array.isArray(opts.fs.dir) ? opts.fs.dir : [opts.fs.dir]).map((dir) =>
        isAbsolute(dir)
          ? dir
          : fileURLToPath(new URL(dir, globalThis._importMeta_.url))
      )
    : void 0;
...
const getClientManifest = () =>
  import(
    "file:///home/braip/%C3%81rea%20de%20Trabalho/braip/Simulate-Marktplace/marketplace/.nuxt/dist/server/client.manifest.mjs"
  )
    .then((r) => r.default || r)
